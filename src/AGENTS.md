...
- **Evaluator Pattern**: `ThoughtEvaluator` — stateless quality signal computation (transient DI).
...
- **Types Module**: `src/types/` holds pure type definitions (Tool, Skill, ServerConfig, IDisposable) — no runtime code.
